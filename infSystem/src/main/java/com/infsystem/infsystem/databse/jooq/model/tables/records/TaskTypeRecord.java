...
public class TaskTypeRecord extends UpdatableRecordImpl<TaskTypeRecord> implements Record2<Integer, String> {
    ...
    private static final long serialVersionUID = 1347835601;

    /**
     * Setter for <code>inf.task_type.id</code>.
     */
    ...
    /**
     * Getter for <code>inf.task_type.id</code>.
     */
    ...
    /**
     * Setter for <code>inf.task_type.name</code>.
     */
    ...
    /**
     * Getter for <code>inf.task_type.name</code>.
     */
     ...
     */
    public TaskTypeRecord(Integer id, String name) {
        super(TaskType.TASK_TYPE);
